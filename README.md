...
function defineDecoratedProperty(target,name, { initializer, enumerable, configurable, writable }) {
  Object.defineProperty(target, name,{ value: initializer(), enumerable, configurable, writable });
}
```
